...
export default function TimeTableEngine({tool,locale='en'}:{tool:ToolMeta;locale?:LocaleCode}){
  ...
  const [scheduleTitle,setScheduleTitle]=useState(''); const [personalNote,setPersonalNote]=useState(''); const [quote,setQuote]=useState(''); const [openTimePicker,setOpenTimePicker]=useState<string|null>(null);
