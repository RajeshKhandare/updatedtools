...
export const INTERNATIONAL_MARKET_EVIDENCE: readonly InternationalMarketEvidence[] = [
  {
    locale: 'pt-BR',
    market: 'Brazil',
    sourceUrls: ['https://www.webfacilita.com/', 'https://andev.app/pt/', 'https://makeitpdf.com/pt/'],
  ...
  },
  {
    locale: 'de',
    market: 'Germany / DACH',
    sourceUrls: ['https://www.pageonaut.com/de/', 'https://www.pageonaut.com/de/tools', 'https://makeitpdf.com/de/'],
  ...
  },
  {
    locale: 'it',
    market: 'Italy',
    sourceUrls: ['https://www.ilovepdf.com/it', 'https://www.ilovepdf.com/it/aiuto/documentazione', 'https://makeitpdf.com/it/'],
  ...
  },
  {
    locale: 'ko',
    market: 'South Korea',
    sourceUrls: ['https://www.oneclicktool.kr/', 'https://veryeasypdf.com/ko'],
  ...
  },
  {
    ...
    sourceUrls: ['https://adawix.com/', 'https://experttoolskit.com/ar/', 'https://www.ilovepdf.com/ar'],
