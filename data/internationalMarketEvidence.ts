...
export const INTERNATIONAL_MARKET_EVIDENCE: readonly InternationalMarketEvidence[] = [
  ...
  },
  {
    locale: 'hi',
    market: 'India',
    sourceUrls: ['https://fastols.com/hi/', 'https://convertforever.com/hi/', 'https://www.ilovepdf.com/hi', 'https://utilokit.com/hi', 'https://hoomaninfotech.com/hi/tools'],
    observedTerms: ['PDF फ़ाइलें मर्ज करें', 'PDF मर्ज करें', 'PDF कंप्रेस करें', 'PDF स्प्लिट करें', 'PDF को Word में बदलें', 'Word से PDF', 'PDF से JPG', 'JPG से PDF', 'PDF को पासवर्ड से सुरक्षित करें', 'PDF पेज घुमाएं', 'PDF पेज व्यवस्थित करें', 'इमेज कंप्रेस करें', 'इमेज का आकार बदलें', 'इमेज फ़ॉर्मेट बदलें', 'इमेज क्रॉप करें', 'इमेज फ्लिप करें', 'इमेज ब्लर करें', 'JSON फ़ॉर्मेटर', 'JSON वैलिडेटर', 'Base64 एनकोडर', 'URL एनकोड / डिकोड', 'UUID जनरेटर', 'पासवर्ड जनरेटर', 'JWT डिकोडर', 'डिफ चेकर', 'वर्ड काउंटर', 'कैरेक्टर काउंटर', 'केस कन्वर्टर', 'टेक्स्ट कंपेयर', 'प्रतिशत कैलकुलेटर', 'उम्र कैलकुलेटर', 'BMI कैलकुलेटर', 'लोन कैलकुलेटर', 'डिस्काउंट कैलकुलेटर', 'GST कैलकुलेटर', 'सैलरी कैलकुलेटर', 'ऑनलाइन Python कंपाइलर', 'ऑनलाइन JavaScript कंपाइलर', 'ऑनलाइन Java कंपाइलर', 'ऑनलाइन C++ कंपाइलर', 'ऑनलाइन C# कंपाइलर', 'ऑनलाइन PHP कंपाइलर', 'ऑनलाइन SQL एडिटर', 'YouTube थंबनेल डाउनलोडर', 'YouTube टैग जनरेटर', 'YouTube मनी कैलकुलेटर', 'QR कोड जनरेटर'],
