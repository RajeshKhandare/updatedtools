...
const ADDITIONAL_CATALOG_VALIDATIONS: readonly InternationalKeywordValidation[] = [
  ...
  ...([
    ...
    ['ar','pdf-grayscale-converter','PDF إلى تدرج رمادي',['تحويل PDF إلى تدرج الرمادي'],'https://toolsrio.com/ar/tools/grayscale-pdf'],
    ['hi','pdf-grayscale-converter','PDF को ग्रेस्केल में बदलें',['PDF ग्रेस्केल कनवर्टर'],'https://www.pdfwind.com/hi/grayscale-pdf'],
    ['it','pdf-grayscale-converter','Convertitore PDF in scala di grigi',['PDF in scala di grigi'],'https://utiliome.com/it/tools/pdf-grayscale/'],
    ['de','time-duration-converter','Zeit umrechnen',['Zeitumrechner'],'https://experttoolskit.com/de/'],
    ['fr','time-duration-converter','Convertisseur de temps',['conversion de temps'],'https://experttoolskit.com/fr/'],
    ['it','time-duration-converter','Convertitore di tempo',['conversione del tempo'],'https://experttoolskit.com/it/'],
    ['es','area-land-converter','Conversor de área',['convertidor de área'],'https://uselocaltools.com/es'],
    ['de','area-land-converter','Flächenumrechner',['Fläche umrechnen'],'https://experttoolskit.com/de/'],
    ['fr','area-land-converter','Convertisseur de surface',['conversion de surface'],'https://experttoolskit.com/fr/'],
    ['it','area-land-converter','Convertitore di area',['conversione dell’area'],'https://experttoolskit.com/it/'],
    ['es','pressure-unit-converter','Conversor de presión',['convertidor de presión'],'https://uselocaltools.com/es'],
    ['de','pressure-unit-converter','Druckumrechner',['Druck umrechnen'],'https://experttoolskit.com/de/'],
    ['fr','pressure-unit-converter','Convertisseur de pression',['conversion de pression'],'https://experttoolskit.com/fr/'],
    ['it','pressure-unit-converter','Convertitore di pressione',['conversione della pressione'],'https://experttoolskit.com/it/'],
    ['es','energy-work-converter','Conversor de energía',['convertidor de energía'],'https://uselocaltools.com/es'],
    ['de','energy-work-converter','Energieumrechner',['Energie umrechnen'],'https://experttoolskit.com/de/'],
    ['fr','energy-work-converter','Convertisseur d’énergie',['conversion d’énergie'],'https://experttoolskit.com/fr/'],
    ['it','energy-work-converter','Convertitore di energia',['conversione dell’energia'],'https://experttoolskit.com/it/'],
    ['es','power-wattage-converter','Conversor de potencia',['convertidor de potencia'],'https://uselocaltools.com/es'],
    ['de','power-wattage-converter','Leistungsumrechner',['Leistung umrechnen'],'https://experttoolskit.com/de/'],
    ['fr','power-wattage-converter','Convertisseur de puissance',['conversion de puissance'],'https://experttoolskit.com/fr/'],
    ['it','power-wattage-converter','Convertitore di potenza',['conversione della potenza'],'https://experttoolskit.com/it/'],
    ['en','user-agent-parser','User Agent Parser',['UA parser'],'https://zumatools.com/user-agent-parser/'],
    ['es','strip-html-tags','Eliminar etiquetas HTML',['quitar etiquetas HTML'],'https://uselocaltools.com/es'],
    ['de','strip-html-tags','HTML-Tags entfernen',['HTML Tags löschen'],'https://experttoolskit.com/de/'],
    ['fr','strip-html-tags','Supprimer les balises HTML',['retirer les balises HTML'],'https://experttoolskit.com/fr/'],
    ['it','strip-html-tags','Rimuovi tag HTML',['eliminare tag HTML'],'https://experttoolskit.com/it/'],
    ['hi','lumpsum-calculator','लंपसम कैलकुलेटर',['एकमुश्त निवेश कैलकुलेटर'],'https://www.calculator.net/'],
    ['hi','fd-calculator','FD कैलकुलेटर',['फिक्स्ड डिपॉजिट कैलकुलेटर'],'https://www.calculator.net/'],
    ['hi','rd-calculator','RD कैलकुलेटर',['रिकरिंग डिपॉजिट कैलकुलेटर'],'https://www.calculator.net/'],
    ['hi','simple-interest-calculator','साधारण ब्याज कैलकुलेटर',['Simple Interest Calculator'],'https://www.calculator.net/'],
  ] as const).map(([locale,slug,primary,alternate,sourceUrl]) => ({locale,slug,primaryKeyword:primary,alternateKeywords:[...alternate],intent:'tool' as const,sourceUrls:[sourceUrl],notes: locale === 'en' ? 'English developer terminology reference; used as a terminology anchor, not search volume or ranking.' : 'Localized terminology candidate from public tool resources; wording evidence only, not search volume or ranking.'})),
