...
export const TOOLS_REGISTRY: ToolMeta[] = [
  ...
  {
    name: 'Add Page Numbers to PDF Online',
  ...
  {
    name: 'Word to PDF Converter Online',
    slug: 'word-to-pdf',
    category: 'PDF',
  ...
  {
    name: 'PDF to Grayscale Converter Online',
  ...
  {
    name: 'Black and White Image Converter Online',
  ...
  {
    name: 'Flip and Rotate Image Online',
  ...
  {
    name: 'Image Color Palette Generator Online',
  ...
  // ==========================================
  {
    name: 'JSON Formatter and Validator Online',
  ...
  {
    name: 'URL Slug Generator Online',
  ...
  {
    name: 'HEX to RGB Converter Online',
  ...
  {
    name: 'Reverse Text Generator Online',
  ...
  {
    name: 'Alphabetical Order Tool Online',
