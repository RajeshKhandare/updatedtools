...
export default function ToolPage({ params }: { params: { slug: string } }) {
  ...
  const renderEngine = () => {
    ...
    if (cat.includes('compiler') || slug.includes('compiler') || slug.includes('sql') || slug.includes('editor'))
    ...
    if (['Developer','Text','Converters','Calculators'].includes(tool.category)) return <UtilityEngine toolSlug={tool.slug} toolName={tool.name} category={tool.category} />;
